...
# Step 1:
# Alice
pykyber_90s.pqcrystals_kyber512_90s_ref_keypair()
print("Alice's public key:")
alice_pk = pykyber_90s.pqcrystals_get_pk()
print(alice_pk)
print("\nAlice's secret key:")
alice_sk = pykyber_90s.pqcrystals_get_sk()
print(alice_sk)
...
pykyber_90s.pqcrystals_kyber512_90s_ref_keypair()
print("\nBob's public key:")
bob_pk = pykyber_90s.pqcrystals_get_pk()
print(bob_pk)
print("\nBob's secret key:")
bob_sk = pykyber_90s.pqcrystals_get_sk()
print(bob_sk)
